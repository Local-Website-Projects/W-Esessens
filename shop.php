...
<head>
    <title>ESESSENS | Shop - Handcrafted Fragrances</title>
    <meta charset="UTF-8">
                            ...
                            <div class="item-banner style1">
                                <div class="inner equal-element">
                                    <div class="banner-content style1">
                                        <h4 class="stelina-subtitle">Start ur weekend off right!</h4>
                                        <h3 class="title">Flash Sale Up To<br/> 15% Off</h3>
                                        <span class="when-code">When Use Code: <span class="code">STELINA</span></span>
